...
def setup_controller_configuration(context: LaunchContext):
    ...
    controller_name = f'pelvis_jtc_impedance_{interface_level}_controller'
    remappings = {'INTERFACE_LEVEL': interface_level}

    param_file = os.path.join(
        get_package_share_directory('kangaroo_controller_configuration'),
        'config', 'pelvis_jtc_impedance_controller.yaml')
