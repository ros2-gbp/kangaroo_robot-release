...
Name:           ros-humble-kangaroo-controller-configuration
Version:        2.15.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS kangaroo_controller_configuration package

License:        Apache License 2.0
URL:            https://index.ros.org/p/kangaroo_controller_configuration/#humble
